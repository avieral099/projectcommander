...
pairs = (
    (
        ...
        Path("decision_engine.py.v2"),
        Path("decision_engine_before_execution_v2.py"),
    ),
    (
        Path("commander_summary_panel.py"),
        Path("commander_summary_panel.py.v2"),
        Path("commander_summary_panel_before_execution_v2.py"),
    ),
)
...
print("EXECUTION DECISION V2 INSTALLED")
