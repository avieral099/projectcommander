...
EXECUTION_TERMINAL_LOCK = Path(".execution_terminal.lock")


def acquire_execution_terminal_lock():
    handle = EXECUTION_TERMINAL_LOCK.open("w")
    ...
    try:
        ...
        handle.close()
        raise RuntimeError(
            "Execution Terminal already running; "
...
if __name__=="__main__":
    execution_terminal_lock_handle = acquire_execution_terminal_lock()
    main()
